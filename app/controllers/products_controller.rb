class ProductsController < ApplicationController
  before_action :set_product, only: %i[ show edit update destroy ], :authenticate_user!
  ...
  private
    ...
    def product_params
      params.require(:product).permit(:journey_id, :product_type, :name, :launch_days_offset, :event_days_offset)
    end
end
